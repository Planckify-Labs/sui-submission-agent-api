...
const CORE_HANDOFF: ToolMeta = {
  ...
  capability: 'read',
  description:
    'Delegate the turn to a named specialist agent (e.g. defi, wallet). Use when the work is conversational rather than tool-shaped (e.g. "explain liquid-staking risks"). Set conversational: true to let the specialist stream prose directly to the user.',
  inputSchema: {
    type: 'object',
    properties: {
      to: {
