...
const DEFI_INTENT_PREVIEW: ToolMeta = {
  ...
  description:
    ...
    'stale-pool / over-concentration). This PREPARES the transaction only: ' +
    'it signs NOTHING and moves NO funds — broadcasting happens exclusively ' +
    'in defi_intent_execute. Never tell the user the action executed / ' +
    'swapped / completed off the back of THIS result. Returns an opaque ' +
    'intent_id, a plain-language summary, the decoded PTB commands, and ' +
    'risk_flags. ALWAYS call this before defi_intent_execute. If any ' +
    'risk_flag has severity "block" (or blocked is true), DO NOT execute — ' +
    'explain the risk and offer to adjust. Express the goal as symbols + human amounts ' +
